...
all_cells: int = None
# числовая последовательность от 0 до количества ячеек поля не включая сделанные ходы
all_cells_range: set[range] = None
...
MESSAGES = {
    ...
    'загрузка сохранения': '\n _ Желаете загрузить сохраненную игру? \n',
    'подтверждение или отказ': '\n _ Ответ должен быть "да" или "нет" \n',
